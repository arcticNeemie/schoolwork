...
public abstract class AsyncHTTPRequest extends AsyncTask<String, String,
    ...
    protected String doInBackground(String... params) {
        try {
            Log.d("INTERWEBZ", "connecting to url...");
            ...
            Log.d("INTERWEBZ", "making buffered reader");
            ...
            while (text != null)
            {
                ...
                Log.d("INTERWEBZ", "response: " + response);
                text = br.readLine();
            }
            ...
            Log.d("THIS WAY -->", "Somethings gone wrong with the interwebz");
            e.printStackTrace();
            return "failure";
        }
    }
