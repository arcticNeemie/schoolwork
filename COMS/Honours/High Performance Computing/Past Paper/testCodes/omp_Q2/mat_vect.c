 ...
 *		mat_vect.c
 * Input:
 *     None when DEBUG is not defined
 *
 * Output:
...
/* Parallel function */
void mat_vect(double A[], double x[], double y[],
...
/*    Print_vector("We generated", x, n); */
 # endif
	 printf("Running size: %d by %d, using %d threads: ", m, n, thread_count);
   mat_vect(A, x, y, m, n, thread_count);
